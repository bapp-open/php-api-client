 ...
 *
 * @category Class
 * @description FiscalInvoice(id, created_at, modified_at, snapshot, company, partner, location, currency, language, delegate, uuid, number, date, due_days, status, observations, due_date, discount, has_discount, subtotal, subtotal_currency, tax_value, tax_value_currency, total, total_currency, discounted_total, discounted_total_currency, exchange_rate, exchange_date, created_by, modified_by, extra, series, order, amount_paid, is_storno, former_document_id)
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Fiscal implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'items' => '\Swagger\Client\Model\FiscalItemModel[]',
        'order' => 'int'
    ];
    ...
    protected static $setters = [
        ...
        'former_document_id' => 'setFormerDocumentId',
        'items' => 'setItems',
        'order' => 'setOrder'
    ];
    ...
    protected static $getters = [
        ...
        'former_document_id' => 'getFormerDocumentId',
        'items' => 'getItems',
        'order' => 'getOrder'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['former_document_id'] = isset($data['former_document_id']) ? $data['former_document_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['former_document_id']) && ($this->container['former_document_id'] > 2147483647)) {
            $invalidProperties[] = "invalid value for 'former_document_id', must be smaller than or equal to 2147483647.";
        }

        if (!is_null($this->container['former_document_id']) && ($this->container['former_document_id'] < 0)) {
            $invalidProperties[] = "invalid value for 'former_document_id', must be bigger than or equal to 0.";
        }
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && (mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Fiscal., must be bigger than or equal to 1.');
        }
    ...
    public function setDueDays($due_days)
    {
        ...
        if (!is_null($due_days) && ($due_days > 32767)) {
            throw new \InvalidArgumentException('invalid value for $due_days when calling Fiscal., must be smaller than or equal to 32767.');
        }
        if (!is_null($due_days) && ($due_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $due_days when calling Fiscal., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets former_document_id
     *
     * @return int
     */
    public function getFormerDocumentId()
    {
        return $this->container['former_document_id'];
    }

    /**
     * Sets former_document_id
     *
     * @param int $former_document_id former_document_id
     *
     * @return $this
     */
    public function setFormerDocumentId($former_document_id)
    {

        if (!is_null($former_document_id) && ($former_document_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $former_document_id when calling Fiscal., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($former_document_id) && ($former_document_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $former_document_id when calling Fiscal., must be bigger than or equal to 0.');
        }

        $this->container['former_document_id'] = $former_document_id;
     ...
     * Gets items
     *
     * @return \Swagger\Client\Model\FiscalItemModel[]
     */
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\FiscalItemModel[] $items 
     *
     * @return $this
     */
