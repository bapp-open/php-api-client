...
/**
 * PartnerUpdate Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PartnerUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartnerUpdate';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PartnerUpdate., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PartnerUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setVatId($vat_id)
    {
        if (!is_null($vat_id) && (mb_strlen($vat_id) > 60)) {
            throw new \InvalidArgumentException('invalid length for $vat_id when calling PartnerUpdate., must be smaller than or equal to 60.');
        }
    ...
    public function setRegCom($reg_com)
    {
        if (!is_null($reg_com) && (mb_strlen($reg_com) > 60)) {
            throw new \InvalidArgumentException('invalid length for $reg_com when calling PartnerUpdate., must be smaller than or equal to 60.');
        }
    ...
    public function setSaleDueDays($sale_due_days)
    {
        ...
        if (!is_null($sale_due_days) && ($sale_due_days > 32767)) {
            throw new \InvalidArgumentException('invalid value for $sale_due_days when calling PartnerUpdate., must be smaller than or equal to 32767.');
        }
        if (!is_null($sale_due_days) && ($sale_due_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_due_days when calling PartnerUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setPurchaseDueDays($purchase_due_days)
    {
        ...
        if (!is_null($purchase_due_days) && ($purchase_due_days > 32767)) {
            throw new \InvalidArgumentException('invalid value for $purchase_due_days when calling PartnerUpdate., must be smaller than or equal to 32767.');
        }
        if (!is_null($purchase_due_days) && ($purchase_due_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $purchase_due_days when calling PartnerUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setAddress($address)
    {
        if ((mb_strlen($address) > 200)) {
            throw new \InvalidArgumentException('invalid length for $address when calling PartnerUpdate., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling PartnerUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PartnerUpdate., must be smaller than or equal to 254.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 200)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PartnerUpdate., must be smaller than or equal to 200.');
        }
    ...
    public function setBank($bank)
    {
        if (!is_null($bank) && (mb_strlen($bank) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank when calling PartnerUpdate., must be smaller than or equal to 100.');
        }
    ...
    public function setIban($iban)
    {
        if (!is_null($iban) && (mb_strlen($iban) > 29)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling PartnerUpdate., must be smaller than or equal to 29.');
        }
    ...
    public function setFormerPartnerId($former_partner_id)
    {
        ...
        if (!is_null($former_partner_id) && ($former_partner_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $former_partner_id when calling PartnerUpdate., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($former_partner_id) && ($former_partner_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $former_partner_id when calling PartnerUpdate., must be bigger than or equal to 0.');
        }
