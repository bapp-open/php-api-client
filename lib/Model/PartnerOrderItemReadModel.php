...
/**
 * PartnerOrderItemReadModel Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PartnerOrderItemReadModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartnerOrderItemReadModel';
    ...
    public function setUnit($unit)
    {
        if (!is_null($unit) && (mb_strlen($unit) > 20)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling PartnerOrderItemReadModel., must be smaller than or equal to 20.');
        }
        if (!is_null($unit) && (mb_strlen($unit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling PartnerOrderItemReadModel., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PartnerOrderItemReadModel., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PartnerOrderItemReadModel., must be bigger than or equal to 1.');
        }
