...
class Proforma implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'extra' => 'object',
        'amount_paid' => 'string',
        'items' => '\Swagger\Client\Model\ProformaItemModel[]',
        'order' => 'int'
    ];
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && (mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Proforma., must be bigger than or equal to 1.');
        }
    ...
    public function setDueDays($due_days)
    {
        ...
        if (!is_null($due_days) && ($due_days > 32767)) {
            throw new \InvalidArgumentException('invalid value for $due_days when calling Proforma., must be smaller than or equal to 32767.');
        }
        if (!is_null($due_days) && ($due_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $due_days when calling Proforma., must be bigger than or equal to 0.');
        }
     ...
     * Gets items
     *
     * @return \Swagger\Client\Model\ProformaItemModel[]
     */
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\ProformaItemModel[] $items 
     *
     * @return $this
     */
