...
class Income implements ModelInterface, ArrayAccess
{
    ...
    public function setIdentifier($identifier)
    {
        if (!is_null($identifier) && (mb_strlen($identifier) > 200)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling Income., must be smaller than or equal to 200.');
        }
    ...
    public function setFormerIncomeId($former_income_id)
    {
        ...
        if (!is_null($former_income_id) && ($former_income_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $former_income_id when calling Income., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($former_income_id) && ($former_income_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $former_income_id when calling Income., must be bigger than or equal to 0.');
        }
