...
/**
 * UserTicketMessage Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserTicketMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserTicketMessage';
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 200)) {
            throw new \InvalidArgumentException('invalid length for $title when calling UserTicketMessage., must be smaller than or equal to 200.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling UserTicketMessage., must be bigger than or equal to 1.');
        }
