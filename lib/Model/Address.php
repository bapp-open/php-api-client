...
class Address implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Address., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
    ...
    public function setAddress($address)
    {
        if ((mb_strlen($address) > 200)) {
            throw new \InvalidArgumentException('invalid length for $address when calling Address., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling Address., must be bigger than or equal to 1.');
        }
