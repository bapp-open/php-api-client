 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductVendor implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductVendor';
    ...
    public function setUnit($unit)
    {
        if (!is_null($unit) && (mb_strlen($unit) > 40)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling ProductVendor., must be smaller than or equal to 40.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductVendor., must be smaller than or equal to 200.');
        }
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 40)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ProductVendor., must be smaller than or equal to 40.');
        }
    ...
    public function setCodeEan($code_ean)
    {
        if (!is_null($code_ean) && (mb_strlen($code_ean) > 40)) {
            throw new \InvalidArgumentException('invalid length for $code_ean when calling ProductVendor., must be smaller than or equal to 40.');
        }
