...
class Order implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'extra' => 'object',
        'items' => '\Swagger\Client\Model\OrderItemModel[]',
        'created_by' => 'string',
        'modified_by' => 'string'
    ];
    ...
    public function setSourceText($source_text)
    {
        if (!is_null($source_text) && (mb_strlen($source_text) > 100)) {
            throw new \InvalidArgumentException('invalid length for $source_text when calling Order., must be smaller than or equal to 100.');
        }
    ...
    public function setDeliveryIdentifier($delivery_identifier)
    {
        if (!is_null($delivery_identifier) && (mb_strlen($delivery_identifier) > 100)) {
            throw new \InvalidArgumentException('invalid length for $delivery_identifier when calling Order., must be smaller than or equal to 100.');
        }
    ...
    public function setDeliveryAddress($delivery_address)
    {
        if (!is_null($delivery_address) && (mb_strlen($delivery_address) > 200)) {
            throw new \InvalidArgumentException('invalid length for $delivery_address when calling Order., must be smaller than or equal to 200.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && (mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Order., must be bigger than or equal to 1.');
        }
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\OrderItemModel[] $items 
     *
     * @return $this
     */
