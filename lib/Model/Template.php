...
class Template implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 120)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Template., must be smaller than or equal to 120.');
        }
        if ((mb_strlen($name) < 1)) {
     ...
     * Sets default
     *
     * @param bool $default Setat ca implicit
     *
     * @return $this
     */
