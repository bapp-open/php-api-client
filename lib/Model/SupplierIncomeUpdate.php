...
/**
 * SupplierIncomeUpdate Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SupplierIncomeUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SupplierIncomeUpdate';
    ...
    public function setIdentifier($identifier)
    {
        if (!is_null($identifier) && (mb_strlen($identifier) > 200)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling SupplierIncomeUpdate., must be smaller than or equal to 200.');
        }
